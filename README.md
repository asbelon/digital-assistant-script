...
использовать как список. Например, если заданы две переменной Переменная[Свойство][ОдноСвойство]
и Переменная[Свойство][ДругоеСвойство], то в можно использовать переменные как список $Переменная[Свойство]
